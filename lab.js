...
const checkAge = () =>{
  ...
  else if(amysAge < brittanisAge || amysBirthYear > brittanisAge){
    name = "Brittan";
    console.log(`${name} is older`)
  }
  else{
...
const sameYeart = (amysBirthYear == brittanisAge) ? "Amy & Brittani were born in the same year" : "Amy & Brittani were not born in the same year";
console.log(sameYeart);
sameYear();
